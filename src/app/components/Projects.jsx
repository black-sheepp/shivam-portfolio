...
const projects = [
	{
		name: "ERS",
		description:
			"Created an ERS web app using NodeJs,ExpressJs,MongoDB stack with secure authentication, a user-friendly interface, and a scalable MongoDB database for seamless feedback submission among colleagues.",
		technologies: [
			"NodeJs",
			"ExpressJS",
			"EJS",
	...
	},
	{
		...
		technologies: ["NodeJs", "ExpressJS", "JWT Auth", "MongoDB", "Mongoose", "RestAPI","CRUD Operations"],
